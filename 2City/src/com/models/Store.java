...
public class Store extends Rating implements Serializable{
	...
	@JsonProperty("date_for_ordering")
	String date_for_ordering;
	
	@JsonProperty("buy_ticket")
	String buy_ticket;
	...
	public void setBuy_ticket(String buy_ticket) {
	...
	public String getDate_for_ordering() {
		return date_for_ordering;
	}

	public void setDate_for_ordering(String date_for_ordering) {
		this.date_for_ordering = date_for_ordering;
	}
