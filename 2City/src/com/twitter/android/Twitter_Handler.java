...
public class Twitter_Handler {
	...
	public void handleMessage(Message msg) {
		...
		if (msg.arg1 == 1){
			Log.d("System out","(String) msg.obj:  "+(String) msg.obj);
		    showLoginDialog((String) msg.obj);
		}else{
			Log.d("System out","onComplete(BLANCK)");
...
//		String profileUrl = mSharedPreferences.getString(PROFILE_PICTURE, "");
    	String profileUrl = getUser().getProfileImageURL();
...
//		String profileUrl = mSharedPreferences.getString(PROFILE_PICTURE1, "");
		String profileUrl = getUser().getProfileImageURLHttps();
